...
if (playerFinalScore < 5) {
    resultShow.innerText = `You scored ${playerFinalScore} of 15! Needs improvement! Please click restart.`;
} else {
    resultShow.innerText = `You scored ${playerFinalScore} of 15! Good work!`;
}